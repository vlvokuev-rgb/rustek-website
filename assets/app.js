...
(function(){
  ...
  var REGIONS = {
    ...
    uz:{en:{name:'Uzbekistan',bloc:'Central Asia',sys:'National scheme (O\u2018zDSt)',body:'Outside the EAEU — operates a national certification scheme. We advise on the correct national documents and conformity route for each equipment type.'},
